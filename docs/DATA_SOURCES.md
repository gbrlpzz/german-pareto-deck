...
| Tatoeba `deu_links.tsv.bz2` + `eng_sentences_detailed.tsv.bz2` | EN translations for examples | downloads.tatoeba.org/exports/per_language/… | pending | pending | CC BY 2.0 FR |
...
| Wiktionary REST definitions | EN glosses for word cards (best-effort) | en.wiktionary.org/api/rest_v1/ | planned | — | CC BY-SA 3.0 / GFDL (definitions) |
